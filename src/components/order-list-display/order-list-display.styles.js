...
export const OrderListDisplaySC = styled(Box)`
  width: 100% !important;
...
export const OrderListEmptySC = styled(Box)`
  display: flex !important;
...
export const OrderListEmptyIconSC = styled(Icon)`
...
export const OrderListEmptyDescriptionSC = styled(Typography)`
  width: 50% !important;
